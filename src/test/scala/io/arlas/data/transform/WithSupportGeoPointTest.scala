...
class WithSupportGeoPointTest extends ArlasTest {
  ...
  val testData = Seq(
    ...
    ("ObjectA",
     ...
     0.032068662532024,
     0.32068662532024,
     ArlasVisibilityStates.VISIBLE.toString),
    ("ObjectA",
  ...
  val expectedData = Seq(
    ...
    ("ObjectA",
     ...
     0.032068662532024,
     -1.0,
     ArlasVisibilityStates.INVISIBLE.toString,
     1527804001l),
    ("ObjectA",
     null,
     55.920875,
  ...
  val expectedDF = spark
    ...
    .withColumn("distance",
                when(col("distance").equalTo(lit(-1.0)), lit(null)).otherwise(col("distance")))
  ...
  "WithSupportGeoPoint " should "add invisible support geopoint" in {
    ...
    val transformedDF = testDF
      .enrichWithArlas(
        ...
        new WithSupportGeoPoint(testDataModel,
                                spark,
                                5,
                                10,
                                1.0,
